...
- `groupMessages()` transforms flat `ChatMessageUI[]` into a `DisplayItem[]` tree (20 kinds: user, assistant, thought, thought_group, tool, tool_confirm, ask_user, step_limit, resume_action, error, service, plan_step, subagent, reflection, step_finish, context_compaction, memory_read, plan_review, goal_proposal, checklist).

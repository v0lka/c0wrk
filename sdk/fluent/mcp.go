...
//
//	fluent.MCPStdio("filesystem", "npx", "-y", "@modelcontextprotocol/server-filesystem", workDir)
...
//
//	name, entry := fluent.MCPHTTP("remote", "https://mcp.example.com/sse")
//	fw, _ := fluent.New(fluent.WithMCPServer(name, entry), ...)

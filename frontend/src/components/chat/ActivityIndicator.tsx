...
export function ActivityIndicator() {
  ...
  // slot with the blinking dot alone — no label text — while the task runs.
  // When NO task is running (idle session) the slot still collapses.

...
| Tool policies, confirmations, judge      | [architecture/security-model.md](architecture/security-model.md), [decisions/026-smart-approve-unified-funnel.md](decisions/026-smart-approve-unified-funnel.md), [decisions/028-session-pinned-judge.md](decisions/028-session-pinned-judge.md), [decisions/052-flowsh-command-analysis.md](decisions/052-flowsh-command-analysis.md)         |
| Shell command analysis (blocklist, flowsh criteria C1–C8, canonical hard reasons, ⊤ semantics) | [decisions/052-flowsh-command-analysis.md](decisions/052-flowsh-command-analysis.md), [architecture/security-model.md](architecture/security-model.md) (Shell Command Analysis), [domains/verify-on-edit.md](domains/verify-on-edit.md) (canonical-only gate) |

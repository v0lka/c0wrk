...
| Embedding execution provider (GPU/CUDA), `fetch-onnx-gpu` packaging, embedding fallback semantics | [decisions/042-gpu-embedding-provider.md](decisions/042-gpu-embedding-provider.md), [domains/workspace.md](domains/workspace.md) (Embedding Execution Provider section) |

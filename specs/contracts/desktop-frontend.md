...
> The former `SaveReviewPrompt` RPC was removed by [ADR-054](../decisions/054-remove-post-task-review-prompt.md) together with the post-task review prompt it persisted.

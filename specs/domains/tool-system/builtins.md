...
- Per-tool Stage 1 truncation produces a fragmentation nudge with the short cache hash (abbreviated SHA256 of the full result); the LLM uses `tool_result_read(hash, start_line, num_lines)` to retrieve fragments

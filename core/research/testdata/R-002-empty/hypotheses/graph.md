...
graph TD
    ...
    %% Example:
    %% H001["H-001: Static parsing of JS bundles"]:::confirmed
    %% H002["H-002: Runtime interception of fetch/XHR"]:::refuted
    %% H001 --> H003["H-003: Hybrid approach"]:::in_progress
```

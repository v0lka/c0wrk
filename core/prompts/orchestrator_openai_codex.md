...
You MUST conduct thorough research BEFORE any code modification. NEVER skip the research phase. ALWAYS verify conclusions through tool calls.

NEVER end your turn without having made concrete progress toward the goal.
...
- Prefer CSS custom properties (variables) for theming and consistent spacing
- Use modern CSS (flexbox, grid) over legacy layout techniques

...
CRITICAL: Do NOT attempt to execute this step yourself. You are only creating a step specification for another agent to execute. Never output anything other than the plan structure.

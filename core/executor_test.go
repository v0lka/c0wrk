...
func TestExecutor_BasicReActFlow(t *testing.T) {
	...
	executor := agent.NewExecutor(mockLLM, mockTools, nil, 10, nil, false, ToolResultBudget{})
...
func TestExecutor_MaxStepsReached(t *testing.T) {
	...
	executor := agent.NewExecutor(mockLLM, mockTools, nil, 3, nil, false, ToolResultBudget{})
...
func TestExecutor_SuppressAssistantEvents_True(t *testing.T) {
	...
	executor := agent.NewExecutor(mockLLM, mockTools, nil, 10, mockEm, true, ToolResultBudget{})
...
func TestExecutor_SuppressAssistantEvents_False(t *testing.T) {
	...
	executor := agent.NewExecutor(mockLLM, mockTools, nil, 10, mockEm, false, ToolResultBudget{})
...
func TestExecutor_ToolResultBudget_HardCap(t *testing.T) {
	...
	executor := agent.NewExecutor(mockLLM, mockTools, nil, 10, nil, false, budget)

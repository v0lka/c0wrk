...
var ToolProfiles = map[string][]string{
	"router":    {},
	"planner":   {"read_file", "list_directory", "search_files", "search_content", "ripgrep", "glob", "semantic_search"},
	"reflector": {"read_file", "list_directory", "search_files", "search_content", "ripgrep", "glob", "read_evidence", "semantic_search"},
